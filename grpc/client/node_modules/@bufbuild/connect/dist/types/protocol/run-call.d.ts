import type { AnyMessage, Message, MessageType, PartialMessage } from "@bufbuild/protobuf";
 ...
 */
export declare function normalizeIterable<T extends Message<T>>(messageType: MessageType<T>, input: AsyncIterable<PartialMessage<T>>): AsyncIterable<T>;
export {};
