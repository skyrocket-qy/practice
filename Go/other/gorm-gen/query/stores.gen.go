...
func newStore(db *gorm.DB, opts ...gen.DOOption) store {
	...
	_store.CreatedAt = field.NewTime(tableName, "CreatedAt")
	_store.UpdatedAt = field.NewTime(tableName, "UpdatedAt")
	_store.DeletedAt = field.NewTime(tableName, "DeletedAt")
	_store.Name = field.NewString(tableName, "Name")
	_store.ParentID = field.NewInt32(tableName, "ParentID")
...
func (s *store) updateTableName(table string) *store {
	...
	s.ParentID = field.NewInt32(table, "ParentID")
