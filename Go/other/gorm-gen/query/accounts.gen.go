...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.CreatedAt = field.NewTime(tableName, "CreatedAt")
	_account.UpdatedAt = field.NewTime(tableName, "UpdatedAt")
	_account.DeletedAt = field.NewTime(tableName, "DeletedAt")
	_account.UserName = field.NewString(tableName, "UserName")
	_account.State = field.NewInt32(tableName, "State")
	_account.HashPass = field.NewBytes(tableName, "HashPass")
	_account.Salt = field.NewBytes(tableName, "Salt")
	_account.DisplayName = field.NewString(tableName, "DisplayName")
	_account.RoleID = field.NewInt32(tableName, "RoleID")
...
func (a *account) updateTableName(table string) *account {
	...
	a.HashPass = field.NewBytes(table, "HashPass")
	a.Salt = field.NewBytes(table, "Salt")
	a.DisplayName = field.NewString(table, "DisplayName")
	a.RoleID = field.NewInt32(table, "RoleID")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["HashPass"] = a.HashPass
